...
class _CartPageState extends State<CartPage> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          ...
          style: GoogleFonts.aBeeZee(
            color: Colors.black,
            fontSize: 18, // Adjusted for larger text on wider screens
            fontWeight: FontWeight.bold,
          ),
        ),
        elevation: 0,
              ...
              children: [
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final product = state.cartItems[index];
                      return _cartUI(context, product, screenWidth);
                    },
                  ),
                ),
              ],
  ...
  Widget _cartUI(
      BuildContext context, Map<String, dynamic> cartItem, double screenWidth) {
    final ApiService apiService = ApiService();
